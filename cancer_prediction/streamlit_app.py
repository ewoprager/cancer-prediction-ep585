...
def train_and_save_model(
    ...
    """
    Train a model using the given data and save it to the specified file.
...
if app_mode == "Home":
    st.write(
        "Welcome to the Cancer Diagnosis Prediction Application. Use the "
        "sidebar to navigate through the application."
    )
